(function() {
  ...
  //This value will be used to determine whether we should grab the data from
  ...
  //whether the variable fromLocal is set, it will either grab the value using an external
    ...
    if (!rateio.fromLocal)
    {
      oxr.latest(function(error) {
        if ( error ) {
            ...
            console.log( 'ERROR loading rates from open-exchange-rates! Error was:' )
          ...
          {
            //we need to update the local file
  ...
  //This method updates the local static copy of the exchange rate with the passed
  //in values.
